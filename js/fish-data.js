...
const FishData = {
    types: {
        ...
        vi: {
            id: 'vi', langKey: 'fish_vi',
            name: "Ví Tiền Quản Lý 💰",
    ...
    // Update displayed names from current language
    applyLang() {
        for (const fish of Object.values(this.types)) {
            fish.name = Lang.t(fish.langKey);
        }
    },
